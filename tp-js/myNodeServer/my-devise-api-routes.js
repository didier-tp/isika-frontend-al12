...
var myDeviseDao = require("./my-devisedao-mongoose.js");
var PersistentDeviseModel;

myDeviseDao.initMongooseWithSchemaAndModel(
	function(initPersistentDeviseModel) {
		PersistentDeviseModel=initPersistentDeviseModel;
	}
)
...
.get( function(req , res  , next ) {
	...
	var query={ _id : codeDevise };
    PersistentDeviseModel.findOne(query,
		function(err,devise){
			if(devise==null)
